...
int main(int argc, char** argv) {
    ...
    if (majorGLX <= 1 && minorGLX < 2) {
        ...
        std::cout << "GLX server vendor: " << glXQueryServerString(display, screenId, GLX_VENDOR) << "\n";
    ...
    window = XCreateWindow(display, RootWindow(display, screenId), 0, 0, 320, 200, 0, visual->depth,
    ...
    // either < 3.2 or request profile explicitly,
    // see mesa dri_convert_glx_attribs and driCreateContextAttribs
    int context_attribs[] = {
        GLX_CONTEXT_MAJOR_VERSION_ARB, 3,
        GLX_CONTEXT_MINOR_VERSION_ARB, 2,
        // conflict with GLX_CONTEXT_COMPATIBILITY_PROFILE_BIT_ARB
